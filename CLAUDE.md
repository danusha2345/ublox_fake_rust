...
- `memory.x` - Generated by `build.rs` into OUT_DIR. Defines RP2350 memory layout (BOOT2, FLASH, RAM).
...
- Constant: `pub const FLASH_SIZE_BYTES: usize = 2 * 1024 * 1024;` (2MB, Spotpear RP2350-Core-A)
- Change for different boards (e.g., 4MB = `4 * 1024 * 1024`)
