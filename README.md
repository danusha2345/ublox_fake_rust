...
| Высота | > 10 м | Скачок высоты или вертик. скорость > 15 м/с |
| Ускорение | > 20 м/с² | Нефизичное ускорение (2G) |
| Качество сигнала | аномалии | Подозрительное количество спутников / точность |
...
5. **Дропается оригинальный SEC-SIGN** от реального GNSS (хэш не совпадёт)
6. **Генерируется новый SEC-SIGN** нашим ключом (Air3/Mavic4)
