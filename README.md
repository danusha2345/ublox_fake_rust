...
- **LED**: WS2812B на GPIO16 (только RP2350, на RP2354 отключен)
...
- **Кнопка**: выбор режима по количеству коротких нажатий (таймаут 500мс между нажатиями):
  - **1 нажатие** → Emulation (зелёный)
  - **2 нажатия** → Passthrough (синий)
  - **3 нажатия** → PassthroughRaw (фиолетовый)
- **Индикация LED**:
