...
### Emulation (LED зелёный)

Генерация синтетических GNSS данных:
- Координаты по умолчанию: Москва, Красная площадь (настраиваемо)
...
- **Индикация**: LED мигает зелёным (Emulation) или синим (Passthrough)
...
pub const LATITUDE: f64 = 55.761199;   // Москва
