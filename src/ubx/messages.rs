...
pub mod uniqid {
    ...
    /// DJI Air 3S chip unique ID
    pub const AIR3S: [u8; 5] = [0xE0, 0x86, 0xDB, 0x8F, 0x42];
    /// DJI Mavic 3 Pro chip unique ID (placeholder — same as Air 3S, replace when captured)
    pub const MAVIC3PRO: [u8; 5] = [0xE0, 0x86, 0xDB, 0x8F, 0x42];
}
...
impl SecUniqid {
    ...
    pub fn for_model(model: crate::config::DroneModel) -> Self {
        let unique_id = match model {
            ...
            crate::config::DroneModel::Air3S => uniqid::AIR3S,
            crate::config::DroneModel::Mavic3Pro => uniqid::MAVIC3PRO,
        };
        Self {
            version: 0x02,
...
pub mod cfg41_templates {
    /// Private key offset in CFG-0x41 payload (Air 3 / Mavic 4 Pro)
    pub const PRIVATE_KEY_OFFSET: usize = 175;

    /// Private key offset in CFG-0x41 payload for Air 3S (no CFG-RINV section)
    pub const PRIVATE_KEY_OFFSET_AIR3S: usize = 115;
    ...
    /// Mavic 3 Pro template — no CFG-RINV, no CFG-UART1/CLOCK, unique bitmask, key at offset 115
    pub const TEMPLATE_MAVIC3PRO: [u8; 256] = [
        // Bitmasks (offsets 0-25) — unique to Mavic 3 Pro
        0x8C, 0x84, 0x6D, 0xFF, 0xB2, 0xFF, 0xFE, 0xFF, 0xF7, 0xFF, 0xAF, 0xFF, 0xCF, 0xFF, 0xBF, 0xFF,
        0xEF, 0xFF, 0xFD, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00,
        // ROM Patch #1 (offsets 26-53)
        0x82, 0x18, 0xB0, 0x00, 0x00, 0x00,
        0xF0, 0xA0, 0xF7, 0xF7, 0x00, 0x22, 0x42, 0x60, 0xC0, 0xF8, 0xBC, 0x10, 0x4F, 0xF4, 0x00, 0x31,
        0xC1, 0x67, 0x70, 0x47, 0x00, 0x00,
        // ROM Patch #2 (offsets 54-95)
        0x83, 0x28, 0x8C, 0x16, 0x00, 0x00, 0xF1, 0xA0, 0xF7, 0xF7,
        0x23, 0xF4, 0x40, 0x03, 0x8E, 0x68, 0x46, 0xF4, 0x40, 0x06, 0xC1, 0xF8, 0xBC, 0x20, 0x8E, 0x60,
        0xCE, 0x68, 0xC1, 0xF8, 0xBC, 0x20, 0x46, 0xF4, 0xC0, 0x06, 0xCE, 0x60, 0x70, 0x47, 0x00, 0x00,
        // CFG-SIGNAL (offsets 96-112)
        0xA4, 0x0F, 0x0F, 0x00, 0x31, 0x10, 0x00, 0x0D, 0x00, 0x31, 0x10, 0x01, 0x22, 0x00, 0x31, 0x10,
        0x01,
        // SEC/KEY header (offsets 113-114) + private key placeholder (offsets 115-138)
        0xA6, 0x18,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        // ALL 0xFF padding (offsets 139-255 = 117 bytes) — no CFG-UART1/CLOCK sections
    ...
    /// Air 3S template — no CFG-RINV section, key at offset 115
    pub const TEMPLATE_AIR3S: [u8; 256] = [
        // Bitmasks (offsets 0-25)
        0xCF, 0xAF, 0xB9, 0x7F, 0xC7, 0xFF, 0xFE, 0xFF, 0xF7, 0xFF, 0x9F, 0xFF, 0xFF, 0xB7, 0xBF, 0xFF,
        0xEF, 0xFF, 0xFD, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00,
        // ROM Patch #1 (offsets 26-53)
        0x82, 0x18, 0xB0, 0x00, 0x00, 0x00,
        0xF0, 0xA0, 0xF7, 0xF7, 0x00, 0x22, 0x42, 0x60, 0xC0, 0xF8, 0xBC, 0x10, 0x4F, 0xF4, 0x00, 0x31,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        // CFG-UART1 + CFG-CLOCK (offsets 139-182)
        0xA4, 0x08, 0x01, 0x00, 0x52, 0x40, 0x00, 0x10, 0x0E, 0x00, 0xA4, 0x20, 0x01, 0x00, 0xA4, 0x40,
        0x00, 0xB0, 0x71, 0x0B, 0x03, 0x00, 0xA4, 0x40, 0x00, 0xB0, 0x71, 0x0B, 0x05, 0x00, 0xA4, 0x40,
        0x00, 0xB0, 0x71, 0x0B, 0x0A, 0x00, 0xA4, 0x40, 0x00, 0xD8, 0xB8, 0x05,
        // 0xFF padding (offsets 183-255 = 73 bytes)
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
impl Cfg41 {
    ...
    pub fn for_model(model: crate::config::DroneModel) -> Self {
        use crate::sec_sign::{PRIVATE_KEY_AIR3, PRIVATE_KEY_AIR3S, PRIVATE_KEY_MAVIC4PRO, PRIVATE_KEY_MAVIC3PRO};

        let (mut payload, key, offset) = match model {
            crate::config::DroneModel::Air3 => (
                cfg41_templates::TEMPLATE,
                &PRIVATE_KEY_AIR3,
                cfg41_templates::PRIVATE_KEY_OFFSET,
            ),
            crate::config::DroneModel::Mavic4Pro => (
                cfg41_templates::TEMPLATE,
                &PRIVATE_KEY_MAVIC4PRO,
                cfg41_templates::PRIVATE_KEY_OFFSET,
            ),
            crate::config::DroneModel::Air3S => (
                cfg41_templates::TEMPLATE_AIR3S,
                &PRIVATE_KEY_AIR3S,
                cfg41_templates::PRIVATE_KEY_OFFSET_AIR3S,
            ),
            crate::config::DroneModel::Mavic3Pro => (
                cfg41_templates::TEMPLATE_MAVIC3PRO,
                &PRIVATE_KEY_MAVIC3PRO,
                cfg41_templates::PRIVATE_KEY_OFFSET_AIR3S, // same offset 115
            ),
        };
        payload[offset..offset + 24].copy_from_slice(key);
